...
void GetSurfaceAndBuiltinData(FragInputs fragInputs, float3 V, inout PositionInputs posInput, out SurfaceData surfaceData, out BuiltinData builtinDataRAY_TRACING_OPTIONAL_PARAMETERS)
            {
...
float4 lightmapTexCoord2 = float4(0, 0, 0, 0);
                ...
                builtinData.distortion = surfaceDescription.
Distortion;
                builtinData.distortionBlur = surfaceDescription.
DistortionBlur;
                #endif
...
float4 lightmapTexCoord2 = fragInputs.texCoord2;
                ...
                builtinData.emissiveColor = surfaceDescription.
Emission;
